                            ...
                            <div class="attendee">
                                <table class="table table-responsive-sm text-center">
                                    ...
                                    <tbody>
                                        <tr>
                                            <td>
                                                <img src="{{ asset('depan/images/avatar-4.png') }}" alt=""
                                                    height="60" />
                                            </td>
                                            ...
                                            <td class="align-middle">
                                                <a href="#">
                                                    <img src="depan/images/ic_remove.png" alt="" />
                                                </a>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td>
                                                <img src="{{ asset('depan/images/avatar-5.png') }}" alt=""
                                                    height="60" />
                                            </td>
                                            ...
                                            <td class="align-middle">
                                                <a href="#">
                                                    <img src="{{ asset('depan/images/ic_remove.png') }}" alt="" />
                                                </a>
                                            </td>
                                        </tr>
                                    </tbody>
                        ...
                        <div class="card card-details card-right">
                            ...
                            <div class="bank">
                                <div class="bank-item pb-3">
                                    <img src="{{ asset('depan/images/ic_bank.png') }}" alt="" class="bank-image" />
                                ...
                                <div class="bank-item">
                                    <img src="{{ asset('depan/images/ic_bank.png') }}" alt=""
                                        class="bank-image" />
                                    <div class="description">
                                        <h3>PT Nomads ID</h3>
                                        <p>
...
@push('prepend-style')
    <link rel="stylesheet" href="{{ asset('depan/libraries/gijgo/css/gijgo.min.css') }}" />
@endpush

@push('addon-script')
    <script src="{{ asset('depan/libraries/gijgo/js/gijgo.min.js') }}"></script>
    <script>
        $(document).ready(function() {
            ...
            $('.datepicker').datepicker({
                ...
                icons: {
                    rightIcon: '<img src="{{ asset('depan/images/ic_doe.png') }}" alt="" />'
                }
            });
        });
    </script>
